<template>
  <div>
    ...
    <div class="register">
      ...
      <div class="controls">
        <input name="确认密码" type="checkbox" v-model="isAgree" v-validate="{agree:true}" />
